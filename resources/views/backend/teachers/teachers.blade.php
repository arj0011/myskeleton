      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                {{ Form::open(array('url'=>'admin/teachers','id'=>'formFilter','method'=>'GET')) }}
                <div class="col-sm-1">
                ...
                @endcan
                @can('Import User')
                <a href="javascript:void(0);" id="import_excel" class="importreport btn btn-default">Import Teachers</a>
                <a href="javascript:void(0);" id="download_format" class="btn btn-default">Download Format</a>
                @endcan
                @can('Create User')
                <a href="{{ url("admin/create-teacher") }}" id="create_user" class="btn btn-primary">Create Teachers</a>
                @endcan
              </div>
              @can('Delete User')
              <br />
  ...
  <div class="modal fade" id="modal-import">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          {{ Form::open(array('url'=>'admin/teachers-import','method'=>'POST','id'=>'formImport','files'=> true)) }}
...
$(document).ready(function(){
  ...
  $('.exportreport').click(function () {
    ...
    url = '{{ url("admin/teachers-export") }}'+'?'+param_str;
    window.location = url;
  });
  ...
  $(document).on('click','.deleteUser',function(){
    ...
    swal({
      title: "Are you sure?",
      text: "Your will not be able to recover this teacher!",
      type: "warning",
...
$(document).on('click','.delete_all', function() {
  ...
  {  
    ...
    swal({
      title: "Are you sure?",
      text: "Your will not be able to recover this teachers!",
      type: "warning",
      showCancelButton: true,
      confirmButtonClass: "btn-danger",
      confirmButtonText: "Yes, delete it!",
