          ...
          <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="settings">
                {{ Form::open(array('route' => array('update-profile', encrypt($user->id)),'class'=>'form-horizontal','files'=>true)) }}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="first_name" value="{{ $user->first_name }}" class="form-control" id="inputFName" placeholder="First Name">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="last_name" value="{{ $user->last_name }}" class="form-control" id="inputLName" placeholder="Last Name">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="mobile" value="{{ $user->mobile }}" class="form-control" id="inputMobile" placeholder="Mobile">
