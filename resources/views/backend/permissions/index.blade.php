      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="">
                <a href="{{ URL::to('admin/create-permission') }}" class="btn btn-primary">Add Permission</a>
  ...
  $(document).on('click','.deletePermission',function(){
    ...
    function(){
      $.ajax({
        ...
        url :'{{ url("admin/destroy-permission") }}',
        success : function(response){
          if(response.status){
            swal("Deleted!", "Permission has been deleted.", "success");
